...
- Keyword Research result tables must preserve the Content Planner save workflow. Overview, Related, Suggestions, Ideas, and Difficulty rows should support selecting keywords and saving them to `/content-planner`, not only CSV export.
