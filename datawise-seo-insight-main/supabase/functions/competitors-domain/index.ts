...
serve(async (req) => {
  ...
  try {
    ...
    const { target, location_code = 2840, language_code = 'en' } = await req.json();
    ...
    console.log('Processing competitors domain for:', target);
    ...
    console.error('Error in competitors-domain function:', error);
