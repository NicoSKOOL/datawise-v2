...
serve(async (req) => {
  ...
  try {
    ...
    const { target, location_code = 2840, language_code = 'en', limit = 100 } = await req.json();
    ...
    console.log('Processing ranked keywords for:', target);
    ...
    console.error('Error in ranked-keywords function:', error);
