...
const REQUIRED_SOURCE_MARKERS = [
  ...
  ['AI Visibility Performance tab trigger', 'src/pages/AIVisibility.tsx', '<TabsTrigger value="performance">Performance</TabsTrigger>'],
  ['AI Visibility Performance tab panel', 'src/pages/AIVisibility.tsx', '<PerformanceTab />'],
  ['AI Visibility Instant Check tab preserved', 'src/pages/AIVisibility.tsx', '<AIOverview />'],
  ['AI performance report renders status matrix', 'src/components/rank-tracking/AIVisibilityPanel.tsx', '<AnswerStatusMatrix'],
  ['AI performance report renders KPI rail', 'src/components/rank-tracking/AIVisibilityPanel.tsx', '<KpiRail'],
