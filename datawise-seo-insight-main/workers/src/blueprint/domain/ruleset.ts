...
// contracts/ruleset.ts, importing CLUSTER_RULESET_V2 and PAGE_PLAN_RULESET_V1
...
export const BLUEPRINT_RULESET_VERSION = `${CLUSTER_RULESET_V2.version}+${PAGE_PLAN_RULESET_V1.version}`;
...
export function rulesetVersionForStage(stage: BlueprintStage): string {
  if (CLUSTER_STAGES.has(stage)) return CLUSTER_RULESET_V2.version;
