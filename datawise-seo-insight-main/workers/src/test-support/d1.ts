...
// loaded with the MAIN app schema (src/db/schema.sql). D1 is SQLite, so schema.sql
// and all statements run unmodified.
//
// This mirrors src/blueprint/test-support/d1.ts, which points at the separate
// Blueprint schema. Use this one for anything in the main datawise-db.
